...
Ce lecteur n'inclut **que** des textes et données librement redistribuables.
Chaque source conserve sa licence.

## Textes bibliques

| Traduction | Statut | Source |
|---|---|---|
| Louis Segond (1910) | Domaine public | [getbible.net v2](https://getbible.net) |
| Darby (français) | Domaine public | getbible.net v2 |
| Martin (1744) | Domaine public | getbible.net v2 |
| King James Version | Domaine public | getbible.net v2 |

## Données d'étude

| Donnée | Licence | Source |
|---|---|---|
| Références croisées | **CC-BY** | [openbible.info](https://www.openbible.info/labs/cross-references/) |
...
- **Segond 21** : © Société Biblique de Genève — sous droit d'auteur, non redistribuable.
- Audio et commentaires modernes : sous droits.
